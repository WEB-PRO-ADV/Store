>## NOTE: This repo is a fork of Steve Smith's [Clean Architecture](https://github.com/ardalis/Store) repo with additional code to facilitate publication as a [Visual Studio extension](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store). 
> [More info](https://github.com/GregTrevellick/Store#the-fork)
 

<!--BadgesSTART-->
<!-- Powered by https://github.com/GregTrevellick/ReadMeSynchronizer -->
[![Read Me Synchronizer](https://img.shields.io/badge/-powered%20by%20ReadMeSynchronizer-brightgreen.svg)](https://github.com/GregTrevellick/ReadMeSynchronizer)
[![BetterCodeHub compliance](https://bettercodehub.com/edge/badge/GregTrevellick/Store?branch=master)](https://bettercodehub.com/results/GregTrevellick/Store)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/3b74ee0e8da64daf94199f8a7f2fcf12)](https://www.codacy.com/project/gtrevellick/Store/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=GregTrevellick/Store&amp;utm_campaign=Badge_Grade_Dashboard)
 [![CodeFactor](https://www.codefactor.io/repository/github/GregTrevellick/Store/badge)](https://www.codefactor.io/repository/github/GregTrevellick/Store)
...
[![LGTM Alerts](https://img.shields.io/lgtm/alerts/g/ardalis/Store.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/ardalis/Store/alerts/)
[![Language grade: JavaScript](https://img.shields.io/lgtm/grade/javascript/g/ardalis/Store.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/ardalis/Store/context:javascript)
[![GitHub top language](https://img.shields.io/github/languages/top/GregTrevellick/Store.svg)](https://github.com/GregTrevellick/Store)
[![Github language count](https://img.shields.io/github/languages/count/GregTrevellick/Store.svg)](https://github.com/GregTrevellick/Store)
 [![GitHub issues](https://img.shields.io/github/issues-raw/GregTrevellick/Store.svg)](https://github.com/GregTrevellick/Store/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/GregTrevellick/Store.svg)](https://github.com/GregTrevellick/Store/pulls)
[![GitHub followers](https://img.shields.io/github/followers/GregTrevellick.svg)](https://github.com/GregTrevellick?tab=followers)
[![GitHub stars](https://img.shields.io/github/stars/GregTrevellick/Store.svg)](https://github.com/GregTrevellick/Store)
[![GitHub watchers](https://img.shields.io/github/watchers/GregTrevellick/Store.svg)](https://github.com/GregTrevellick/Store/watchers)
[![Sonar&metric=alert_status](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=alert_status)](https://sonarcloud.io/dashboard?id=Store)
[![Sonar&metric=bugs](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=bugs)](https://sonarcloud.io/component_measures?id=Store&metric=bugs)
[![Sonar&metric=code_smells](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=code_smells)](https://sonarcloud.io/component_measures?id=Store&metric=code_smells)
[![Sonar&metric=coverage](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=coverage)](https://sonarcloud.io/component_measures?id=Store&metric=Coverage)
[![Sonar&metric=duplicated_lines_density](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=duplicated_lines_density)](https://sonarcloud.io/component_measures?id=Store&metric=duplicated_lines)
[![Sonar&metric=ncloc](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=ncloc)](https://sonarcloud.io/component_measures?id=Store&metric=ncloc)
[![Sonar&metric=reliability_rating](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=reliability_rating)](https://sonarcloud.io/component_measures?id=Store&metric=reliability_rating)
[![Sonar&metric=security_rating](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=security_rating)](https://sonarcloud.io/component_measures?id=Store&metric=security_rating)
[![Sonar&metric=sqale_index](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=sqale_index)](https://sonarcloud.io/component_measures?id=Store&metric=sqale_index)
[![Sonar&metric=sqale_rating](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=sqale_rating)](https://sonarcloud.io/component_measures?id=Store&metric=sqale_rating)
[![Sonar&metric=vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=Store&metric=vulnerabilities)](https://sonarcloud.io/component_measures?id=Store&metric=vulnerabilities)
[![Appveyor Build status](https://ci.appveyor.com/api/projects/status/6raa1n0tucf66h0q?svg=true)](https://ci.appveyor.com/project/GregTrevellick/Store)
[![Appveyor unit tests](https://img.shields.io/appveyor/tests/GregTrevellick/Store.svg)](https://ci.appveyor.com/project/GregTrevellick/Store/build/tests)
[![Azure Build Status](https://gregtrevellick.visualstudio.com/Store/_apis/build/status/Store)](https://gregtrevellick.visualstudio.com/Store/_build/latest?definitionId=41)
...
[![Subscribe](https://img.shields.io/badge/subscribe%20to%20receive%20notificatons-grey.svg)](https://github.com/GregTrevellick/Store/subscription)
[![](https://codescene.io/projects/7067/status.svg)](https://codescene.io/projects/7067/jobs/latest-successful/results)

[![Visual Studio Marketplace version](https://img.shields.io/badge/-Store-%23e2165e.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store)
[![Visual Studio Marketplace downloads](https://vsmarketplacebadge.apphb.com/installs/GregTrevellick.Store.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store)
[![Visual Studio Marketplace ratings](https://vsmarketplacebadge.apphb.com/rating/GregTrevellick.Store.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store)
[![Visual Studio Marketplace version](https://vsmarketplacebadge.apphb.com/version/GregTrevellick.Store.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store)
...
## *Now available as a [project template](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store) within Visual Studio.*

## Versions

The master branch is now using .NET Core Version 3.1. If you need a 2.x version use one of these tagged commits:

- [2.2](https://github.com/ardalis/Store/tree/dotnet-core-2.2)
- [2.0](https://github.com/ardalis/Store/tree/dotnet-core-2.0)
...
- [Install the Visual Studio Template](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.Store) and use it within Visual Studio
...
[Steve 'ardalis' Smith](https://github.com/ardalis/Store)
